/*pragma_fatalerror.cxx*/
/** @file
 *
 * @brief Implementation of `#pragma fatalerror("text")'.
 *
 */
#include "../pch.h"
#include "../main.h"

f1::f1pp::pragma_fatalerror::pragma_fatalerror( const core::Iidentifier * ident ):
	super( ident )
{
}

// Properties
const char * f1::f1pp::pragma_fatalerror::get_name() const
{
	return "fatalerror";
}
// {23AECFB9-7CB4-4de9-9FB0-489FA1E51B1A}
const f1::guid_t f1::f1pp::pragma_fatalerror::m_guid =
{ 0x23aecfb9, 0x7cb4, 0x4de9, { 0x9f, 0xb0, 0x48, 0x9f, 0xa1, 0xe5, 0x1b, 0x1a } };
const f1::guid_t & f1::f1pp::pragma_fatalerror::get_guid() const
{
	return m_guid;
}

// Operations
const status_t f1::f1pp::pragma_fatalerror::parse( pp::Iparser & parser, const pp::string & param_str ) const
{
	// Check current state
	...
	// Display the string
	parser.message( syntax::IMSG_FATAL_ERROR_USER_N, buffer.length(), buffer.data() );

	// Exit
	return STATUS_SUCCESS;
}

/*END OF pragma_fatalerror.cxx*/
