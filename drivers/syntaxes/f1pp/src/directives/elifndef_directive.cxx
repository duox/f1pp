...
f1::f1pp::elifndef_directive::elifndef_directive( unsigned flags ) __noexcept:
	super( flags )
{
}
...
unsigned f1::f1pp::elifndef_directive::get_caps( unsigned mask ) const __noexcept
{
...
const status_t f1::f1pp::elifndef_directive::parse( pp::Iparser & parser )
{
	// Check current state
