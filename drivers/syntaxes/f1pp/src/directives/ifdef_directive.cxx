...
f1::f1pp::ifdef_directive::ifdef_directive( unsigned flags ) __noexcept:
	super( flags )
{
}
...
unsigned f1::f1pp::ifdef_directive::get_caps( unsigned mask ) const __noexcept
{
...
const status_t f1::f1pp::ifdef_directive::parse( pp::Iparser & parser )
{
	// Check current state
