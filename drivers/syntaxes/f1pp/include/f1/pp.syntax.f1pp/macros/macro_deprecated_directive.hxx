/*macro_deprecated_directive.hxx*/

class F1_PP_API f1::f1pp::macro_deprecated_directive : public f1::pp::Imacro
{
public:
	typedef f1::pp::Imacro						super;
	typedef f1::f1pp::macro_deprecated_directive	self;
...
/*END OF macro_deprecated_directive.hxx*/
