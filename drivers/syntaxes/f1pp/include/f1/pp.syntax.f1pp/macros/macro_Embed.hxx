...
class F1_PP_API f1::f1pp::macro_Embed : public f1::pp::Imacro
{
public:
	typedef f1::pp::Imacro			super;
	typedef f1::f1pp::macro_Embed	self;
...
protected:
	mutable core::Tweak_ref<f1pp::embed_directive>	m_embed_directive;
	mutable core::Tweak_ref<pp::Iparser>			m_embed_directive_parser;
