...
class F1_SYNTAX_F1PP_API f1::f1pp::macro_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective		super;
	typedef f1::f1pp::macro_directive		self;

	explicit macro_directive( unsigned flags = 0 );
...
public:
	...
	struct frame : public f1::f1pp::Idefinition_frame {
		...
		core::Tref<pp::Imacro>		m_existing_macro;
