...
class F1_PP_API f1::f1pp::message_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective				super;
	typedef f1::f1pp::message_directive		self;

	explicit message_directive( unsigned flags = 0 ) __noexcept;
