...
class F1_PP_API f1::f1pp::print_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective				super;
	typedef f1::f1pp::print_directive		self;

	explicit print_directive( unsigned flags = 0 ) __noexcept;
