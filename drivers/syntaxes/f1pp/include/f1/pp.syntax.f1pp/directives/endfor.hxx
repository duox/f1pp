...
class F1_SYNTAX_F1PP_API f1::f1pp::endfor_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective		super;
	typedef f1::f1pp::endfor_directive	self;

	explicit endfor_directive( unsigned flags = 0 );
