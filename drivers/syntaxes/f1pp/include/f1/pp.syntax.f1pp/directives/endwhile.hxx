...
class F1_SYNTAX_F1PP_API f1::f1pp::endwhile_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective		super;
	typedef f1::f1pp::endwhile_directive	self;

	explicit endwhile_directive( unsigned flags = 0 );
