...
class F1_SYNTAX_F1PP_API f1::f1pp::comment_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective				super;
	typedef f1::f1pp::comment_directive		self;

	explicit comment_directive( unsigned flags = 0 );
...
public:
	...
	struct frame : public f1::c_pp::Iframe {
		...
		pp::null_output	m_output;
		core::Tref<pp::Ioutput>		m_old_output;

		pp::null_storage	m_storage;
