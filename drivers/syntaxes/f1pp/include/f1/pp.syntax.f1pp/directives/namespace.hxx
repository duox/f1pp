...
class F1_SYNTAX_F1PP_API f1::f1pp::namespace_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective		super;
	typedef f1::f1pp::namespace_directive	self;

	explicit namespace_directive( unsigned flags = 0 );
...
public:
	...
	struct frame : public f1::c_pp::Iframe {
		...
		pp::string	m_name;
		core::Tweak_ref<ns::name_space>	m_namespace;
		core::Tweak_ref<ns::name_space>	m_parent_namespace;
