...
class F1_SYNTAX_F1PP_API f1::f1pp::repeat_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective		super;
	typedef f1::f1pp::repeat_directive	self;

	explicit repeat_directive( unsigned flags = 0 );
