...
class F1_SYNTAX_F1PP_API f1::f1pp::assignment_directive : public f1::f1pp::Iassignment_directive
{
public:
	typedef f1::f1pp::Iassignment_directive		super;
	typedef f1::f1pp::assignment_directive		self;

	explicit assignment_directive( unsigned flags = 0 );
