...
class F1_SYNTAX_F1PP_API f1::f1pp::import_directive : public f1::c_pp::c99::include_directive
{
public:
	typedef f1::c_pp::c99::include_directive	super;
	typedef f1::f1pp::import_directive		self;

	explicit import_directive( unsigned flags = 0 );
