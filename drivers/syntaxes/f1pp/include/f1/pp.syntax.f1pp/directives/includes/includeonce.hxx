...
class F1_SYNTAX_F1PP_API f1::f1pp::includeonce_directive : public f1::c_pp::c99::include_directive
{
public:
	typedef f1::c_pp::c99::include_directive	super;
	typedef f1::f1pp::includeonce_directive		self;

	explicit includeonce_directive( unsigned flags = 0 );
