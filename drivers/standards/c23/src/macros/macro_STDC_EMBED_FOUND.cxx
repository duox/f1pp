/*macro_STDC_EMBED_FOUND.cxx*/
#include "../pch.h"
#include "../main.h"

const status_t f1::c_pp::c23::macro_STDC_EMBED_FOUND::initialize( const f1::pp::attribute_list * attrs,
...
const char * f1::c_pp::c23::macro_STDC_EMBED_FOUND::get_name() const
{
	return "__STDC_EMBED_FOUND__";
}

const status_t f1::c_pp::c23::macro_STDC_EMBED_FOUND::expand( pp::Iparser & parser, pp::string & buf, const pp::arg_list * args ) const
{
	// Check current state
...
/*END OF macro_STDC_EMBED_FOUND.cxx*/
