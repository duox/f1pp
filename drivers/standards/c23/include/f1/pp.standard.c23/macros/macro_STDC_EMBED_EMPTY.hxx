/*macro_STDC_EMBED_EMPTY.hxx*/

class F1_PP_API f1::c_pp::c23::macro_STDC_EMBED_EMPTY : public f1::pp::Imacro
{
public:
	typedef f1::pp::Imacro							super;
	typedef f1::c_pp::c23::macro_STDC_EMBED_EMPTY	self;
...
/*END OF macro_STDC_EMBED_EMPTY.hxx*/
