/*macro_STDC_EMBED_FOUND.hxx*/

class F1_PP_API f1::c_pp::c23::macro_STDC_EMBED_FOUND : public f1::pp::Imacro
{
public:
	typedef f1::pp::Imacro							super;
	typedef f1::c_pp::c23::macro_STDC_EMBED_FOUND	self;
...
/*END OF macro_STDC_EMBED_FOUND.hxx*/
