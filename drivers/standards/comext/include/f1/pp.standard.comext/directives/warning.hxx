...
class F1_PP_API f1::c_pp::comext::warning_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective		super;
	typedef f1::c_pp::comext::warning_directive	self;

	explicit warning_directive( unsigned flags = 0 ) __noexcept;
