...
const status_t f1::c_pp::c99::macro_DATE::initialize( const f1::pp::attribute_list * attrs,
...
//	if( create_name( nm, *ns, 0, "__DATE__" ).failed_status( status ) )
//		return status;
...
const char * f1::c_pp::c99::macro_DATE::get_name() const
{
	return "__DATE__";
}

const status_t f1::c_pp::c99::macro_DATE::expand( pp::Iparser & parser, pp::string & buf, const pp::arg_list * args ) const
{
	// Check current state
	...
	char buffer[128];
	strftime( buffer, countof(buffer), "%b %d %Y", newtime );
