...
class F1_PP_API f1::c_pp::c99::endif_directive : public f1::pp::Idirective
{
public:
	typedef f1::pp::Idirective		super;
	typedef f1::c_pp::c99::endif_directive	self;

	explicit endif_directive( unsigned flags = 0 ) __noexcept;
