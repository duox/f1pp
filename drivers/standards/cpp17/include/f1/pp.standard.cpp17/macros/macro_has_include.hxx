/*macro_has_include.hxx*/

class F1_PP_API f1::c_pp::cpp17::macro_has_include : public f1::pp::Imacro
{
public:
	typedef f1::pp::Imacro						super;
	typedef f1::c_pp::cpp17::macro_has_include	self;
