...
class F1_PP_API f1::c_pp::cpp23::standard: public f1::pp::Istandard
{
public:
	typedef f1::pp::Istandard			super;
	typedef f1::c_pp::cpp23::standard	self;
...
protected:
	elifdef_directive	m_elifdef_directive;
	elifndef_directive	m_elifndef_directive;
};
