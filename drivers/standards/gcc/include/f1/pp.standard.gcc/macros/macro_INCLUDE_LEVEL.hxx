/*macro_INCLUDE_LEVEL.hxx*/

class F1_PP_API f1::c_pp::gcc::macro_INCLUDE_LEVEL : public f1::pp::Imacro
{
public:
	typedef f1::pp::Imacro					super;
	typedef f1::c_pp::gcc::macro_INCLUDE_LEVEL	self;
...
/*END OF macro_INCLUDE_LEVEL.hxx*/
