/*switch_merge_strings.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_merge_strings : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_merge_strings	self;

	explicit switch_merge_strings( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_merge_strings.hxx*/
