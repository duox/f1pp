/*switch_deprecate_include.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_deprecate_include : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch							super;
	typedef f1::pp::frontend::f1pp::switch_deprecate_include	self;

	explicit switch_deprecate_include( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_deprecate_include.hxx*/
