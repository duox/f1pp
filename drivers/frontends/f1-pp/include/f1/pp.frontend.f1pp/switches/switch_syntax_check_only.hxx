/*switch_syntax_check_only.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_syntax_check_only : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch								super;
	typedef f1::pp::frontend::f1pp::switch_syntax_check_only		self;

	explicit switch_syntax_check_only( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_syntax_check_only.hxx*/
