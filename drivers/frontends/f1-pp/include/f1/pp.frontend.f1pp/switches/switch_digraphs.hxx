...
class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_digraphs : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch					super;
	typedef f1::pp::frontend::f1pp::switch_digraphs		self;

	explicit switch_digraphs( unsigned flags = 0 ) NOEXCEPT;
