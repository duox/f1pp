/*switch_write_bom.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_write_bom : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch					super;
	typedef f1::pp::frontend::f1pp::switch_write_bom	self;

	explicit switch_write_bom( unsigned flags = 0 ) NOEXCEPT;
