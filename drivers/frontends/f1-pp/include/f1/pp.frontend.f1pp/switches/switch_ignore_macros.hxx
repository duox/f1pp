/*switch_ignore_macros.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_ignore_macros : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_ignore_macros	self;

	explicit switch_ignore_macros( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_ignore_macros.hxx*/
