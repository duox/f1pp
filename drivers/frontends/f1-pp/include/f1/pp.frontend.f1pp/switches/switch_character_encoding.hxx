/*switch_character_encoding.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_character_encoding : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_character_encoding	self;

	explicit switch_character_encoding( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_character_encoding.hxx*/
