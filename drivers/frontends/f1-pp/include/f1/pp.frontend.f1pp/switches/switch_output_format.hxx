/*switch_output_format.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_output_format : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_output_format	self;

	explicit switch_output_format( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_output_format.hxx*/
