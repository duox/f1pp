/*switch_auto_once_includes.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_auto_once_includes : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_auto_once_includes	self;

	explicit switch_auto_once_includes( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_auto_once_includes.hxx*/
