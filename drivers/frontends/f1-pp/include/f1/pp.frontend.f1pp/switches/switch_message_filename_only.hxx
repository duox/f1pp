/*switch_message_filename_only.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_message_filename_only : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_message_filename_only	self;

	explicit switch_message_filename_only( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_message_filename_only.hxx*/
