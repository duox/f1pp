/*switch_dump_macros_on_warning.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_dump_macros_on_warning : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_dump_macros_on_warning	self;

	explicit switch_dump_macros_on_warning( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_dump_macros_on_warning.hxx*/
