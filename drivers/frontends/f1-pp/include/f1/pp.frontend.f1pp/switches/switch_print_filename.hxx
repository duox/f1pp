/*switch_print_filename.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_print_filename : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_print_filename	self;

	explicit switch_print_filename( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_print_filename.hxx*/
