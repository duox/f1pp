/*switch_system_include_base.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_system_include_base : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch							super;
	typedef f1::pp::frontend::f1pp::switch_system_include_base	self;

	explicit switch_system_include_base( unsigned flags = 0 ) NOEXCEPT;
...
protected:
//	core::Tarray<core::string>	m_dirs_to_include;
//	core::Tarray<core::string>	m_dirs_to_exclude;
};

/*END OF switch_system_include_base.hxx*/
