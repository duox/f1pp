/*switch_keep_comments.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_keep_comments : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_keep_comments	self;

	explicit switch_keep_comments( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_keep_comments.hxx*/
