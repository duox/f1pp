/*switch_endianness.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_endianness : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_endianness	self;

	explicit switch_endianness( unsigned flags = 0 ) NOEXCEPT;
