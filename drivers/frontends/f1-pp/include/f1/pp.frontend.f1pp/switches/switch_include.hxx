...
class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_include : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch					super;
	typedef f1::pp::frontend::f1pp::switch_include		self;

	explicit switch_include( unsigned flags = 0 ) NOEXCEPT;
...
protected:
	core::Tarray<core::string>	m_files_to_include;
	core::Tarray<core::string>	m_files_to_exclude;
};

/*END OF switch_include.hxx*/
