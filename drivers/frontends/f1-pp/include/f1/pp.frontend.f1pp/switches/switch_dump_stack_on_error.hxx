/*switch_dump_stack_on_error.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_dump_stack_on_error : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_dump_stack_on_error	self;

	explicit switch_dump_stack_on_error( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_dump_stack_on_error.hxx*/
