...
class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_macro : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_macro	self;

	explicit switch_macro( unsigned flags = 0 ) NOEXCEPT;
	...
	struct macro_state {
		core::string	m_macro_name;
		unsigned		m_flags_to_clear;
		unsigned		m_flags_to_set;
	};
	core::Tarray<macro_state>	m_macro_states;
};

/*END OF switch_macro.hxx*/
