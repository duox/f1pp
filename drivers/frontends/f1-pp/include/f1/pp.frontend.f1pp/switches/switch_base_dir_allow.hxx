/*switch_base_dir_allow.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_base_dir_allow : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch							super;
	typedef f1::pp::frontend::f1pp::switch_base_dir_allow	self;

	explicit switch_base_dir_allow( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_base_dir_allow.hxx*/
