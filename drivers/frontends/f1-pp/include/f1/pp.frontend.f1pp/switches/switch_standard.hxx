...
class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_standard : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch					super;
	typedef f1::pp::frontend::f1pp::switch_standard		self;

	explicit switch_standard( unsigned flags = 0 ) NOEXCEPT;
...
protected:
	//pp::standard_list_t		m_standard_list;
};

/*END OF switch_standard.hxx*/
