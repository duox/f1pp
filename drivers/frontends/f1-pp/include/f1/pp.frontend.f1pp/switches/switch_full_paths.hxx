/*switch_full_paths.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_full_paths : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_full_paths	self;

	explicit switch_full_paths( unsigned flags = 0 ) NOEXCEPT;
