/*switch_system_include_dir.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_system_include_dir : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_system_include_dir		self;

	explicit switch_system_include_dir( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_system_include_dir.hxx*/
