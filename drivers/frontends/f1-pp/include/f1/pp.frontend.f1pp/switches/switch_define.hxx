...
class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_define : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch				super;
	typedef f1::pp::frontend::f1pp::switch_define	self;

	explicit switch_define( unsigned flags = 0 ) NOEXCEPT;
...
public:
//	core::Tarray<pp::context::define_op_desc_t>	m_define_ops;
};

/*END OF switch_define.hxx*/
