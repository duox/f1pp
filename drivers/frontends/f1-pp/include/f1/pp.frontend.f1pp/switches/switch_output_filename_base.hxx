/*switch_output_filename_base.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_output_filename_base : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch						super;
	typedef f1::pp::frontend::f1pp::switch_output_filename_base	self;

	explicit switch_output_filename_base( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_output_filename_base.hxx*/
