/*switch_atsigns_in_identifiers.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_atsigns_in_identifiers : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch								super;
	typedef f1::pp::frontend::f1pp::switch_atsigns_in_identifiers	self;

	explicit switch_atsigns_in_identifiers( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_atsigns_in_identifiers.hxx*/
