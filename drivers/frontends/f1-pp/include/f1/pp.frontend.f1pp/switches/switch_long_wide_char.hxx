/*switch_long_wide_char.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_long_wide_char : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch					super;
	typedef f1::pp::frontend::f1pp::switch_long_wide_char	self;

	explicit switch_long_wide_char( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_long_wide_char.hxx*/
