/*switch_known_pragma.hxx*/

class F1_PP_FRONTEND_F1PP_API f1::pp::frontend::f1pp::switch_known_pragma : public f1::util::cmdline::Iswitch
{
public:
	typedef f1::util::cmdline::Iswitch					super;
	typedef f1::pp::frontend::f1pp::switch_known_pragma	self;

	explicit switch_known_pragma( unsigned flags = 0 ) NOEXCEPT;
...
/*END OF switch_known_pragma.hxx*/
